...
=======================================
Welcome to Mrinversion's documentation!
=======================================
...
The `mrinversion` python package is based on the statistical learning technique
for determining the nuclear magnetic resonance (NMR) tensor distribution from
the NMR spectra.
